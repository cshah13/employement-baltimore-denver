...
This same analysis was conducted on Python. The [full data analysis on Google Collab can be found here](https://github.com/cshah13/workforce-opportunities-baltimore-denver/blob/main/Shah_Baltimore_Denver_Job_Analysis.ipynb). Both graphs for both Baltimore and Denver can be seen above. When creating the graphs in Excel, the software automatically formated the x-axis to be organized, hindering all location names to be shown in the axis. Using Python required more steps to format the graph, but more location names are viewable. Furthermore, Python was easier to use, as altering a code provided the desired outcome rather than needing to navigate through various formulas and buttons on Excel. Although it was a timely process to accurately manipulate the code, the graph from Python looks more professional and detailed.
...
The college degree data was further developed through a Python analysis. The [data analysis conducted on Google Collab can be viewed here](https://github.com/cshah13/workforce-opportunities-baltimore-denver/blob/main/Shah_Baltimore_Denver_College_Analysis.ipynb). A bar chart was created to directly visualize and compare the differences. We can see the 10% difference clearly on the Python graph. It was easier to create a neat visualization on Python, as the software automatically creates a visually appealing output. In Excel, the output needs to be heavily manipulated to become visually appealing. This graph is more clear and a better visualization for college degree holders in Denver and Baltimore. 
...
#### PYTHON ADDITIONS 
The Python analysis led to the same findings since the data was the same. However, the graphs are more visually appealing compared to the graphs from Excel. Furthermore, I extended the analysis regarding the proportion of the population who earned a college degree in Baltimore and Denver. Although the findings are the same, the Python graph allows the audience the better visualize the findings. By using a graph as opposed to a table, we can see the direct differences in the proportion of college degree holders between the two cities. I noticed that Excel was easier for reorganizing the data, but Python was easier for creating visualizations. In the future I can download and sort data in Excel prior to analyzing the data in Python.
